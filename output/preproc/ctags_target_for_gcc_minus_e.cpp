# 1 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino"
# 1 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino"
# 2 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
// #include <HardwareSerial.h>
# 4 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
# 5 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
# 6 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
# 7 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2

# 9 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
# 10 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
# 11 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 2
...
SPIClass * hspi = 
# 31 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 3 4
                 __null
# 31 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino"
                     ;
ADF4351 * PLL = 
# 32 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino" 3 4
               __null
# 32 "e:\\ryush\\Documents\\Git_Local_Repository\\C\\NUEDC_2019\\SPECTRUM_ANALYZER\\ADF4351_UI.ino"
                   ;
...
UIXInputBox dispadc(20, 130, 80, 120, 0x9402, 0x9F05, adcstr);
UIXButton btnadc(140, 220, 80, 120, 0x9402, 0x9F05, "ADC", adcget);

UIXInputBox inptfreq(20, 130, 140, 180, 0x9402, 0x9F05, freqstr);
UIXButton btnapply(20, 100, 185, 225, 0x9402, 0x9F05, "APPLY", btnapplyclick);


UIXButton freqplus(140, 220, 140, 180, 0x4529, 0x9F05, "+", delaybtntrigger);
UIXButton freqminus(140, 220, 185, 225, 0x4529, 0x9F05, "-", delaybtntrigger);

UIXInputBox inptswpconfig(20, 130, 240, 280, 0x9402, 0x9F05, swpstr);
UIXButton btnsweep(140, 220, 240, 280, 0x9402, 0x9F05, "SWEEP", btnsweepclick);


UIXConsole console(sendchar);

UIXPlot plotpanel(30 ,220, 20, 200, xlabel, ylabel, 75, 105, 0, 1000, 0x80FD, 2, true, true);
...
void setup(){
    ...
    PLL = new ADF4351(32 /* 35不能作为输出端口，要换一个*/, 33, hspi);
...
void loop(){
    ...
    if(freqminus.pressed && (trigger_flag==1) && (millis() - lasttrigger) > 500 /* ms*/){
        if(tickflag){
            freq = freq - 0.1;
            frequpdate();
        }
    }
    if(freqplus.pressed && (trigger_flag==1) && (millis() - lasttrigger) > 500 /* ms*/){
        if(tickflag){
            freq = freq + 0.1;
            frequpdate();
        }
